...
import com.p2p.tormaster.util.Constants
import java.security.MessageDigest
import java.security.SecureRandom
import javax.crypto.spec.SecretKeySpec

/**
 * Full BIP-39 Mnemonic implementation with 2048 words and checksum.
 * Synchronized with Client app for Audit compliance.
 */
object MnemonicManager {
    private const val TAG = "MnemonicManager"
    private const val BITS_PER_WORD = 11
    private const val ENTROPY_BYTE_SIZE = 16
    ...
    private val wordList =
        listOf(
            ...
            "banana", "banner", "bar", "barely", "bargain", "barrel", "barrier", "base", "basic", "basket", "battle", "beach",
            ...
            "jewel", "job", "join", "joke", "journey", "joy", "judge", "juice", "jump", "jungle", "junior",
            "junk", "just", "kangaroo", "keen", "keep", "ketchup", "key", "kick", "kid", "kidney", "kind",
            "kingdom", "kiss", "kit", "kitchen", "kite", "kitten", "kiwi", "knee", "knife", "knock", "know",
            "lab", "label", "labor", "ladder", "lady", "lake", "lamp", "language", "laptop", "large", "later",
            ...
            "rescue", "resemble", "resist", "resource", "response", "result", "retire", "retreat", "return",
            ...
            "start", "state", "stay", "steak", "steel", "stem", "step", "stereo", "stick", "still", "sting",
            ...
            "vivid", "vocal", "voice", "void", "volcano", "volume", "vote", "voyage", "wage", "wagon", "wait",
    ...
    fun generateMnemonic(): List<String> {
        val entropy = ByteArray(ENTROPY_BYTE_SIZE)
        ...
        for (i in 0 until Constants.BIP39_WORD_COUNT) {
            mnemonic.add(wordList[bits.substring(i * BITS_PER_WORD, (i + 1) * BITS_PER_WORD).toInt(2)])
        }
        return mnemonic
    }
    ...
    fun isValidMnemonic(mnemonic: List<String>): Boolean {
        ...
        return try {
            ...
            for (word in mnemonic) {
                ...
                bitString.append(index.toString(2).padStart(BITS_PER_WORD, '0'))
            }
            ...
            Log.e(TAG, "Mnemonic validation failed", e)
            false
        }
    }
    ...
    fun deriveKeyFromMnemonic(
        ...
        val entropy = mnemonicToEntropy(mnemonic) ?: throw IllegalArgumentException("Invalid mnemonic")
