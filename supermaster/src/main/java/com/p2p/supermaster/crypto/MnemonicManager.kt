...
object MnemonicManager {
    ...
    private val wordList =
        listOf(
            ...
            "horse", "hospital", "host", "hotel", "hour", "hover", "hub", "huge", "human", "hyphen", "ice",
    ...
    fun deriveKeyFromMnemonic(
        ...
        return SecretKeySpec(HKDF.deriveKey(entropy, salt, "SuperBackup".toByteArray(), Constants.AES_KEY_BYTES), "AES")
    }
