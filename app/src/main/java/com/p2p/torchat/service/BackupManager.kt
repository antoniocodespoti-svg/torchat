...
data class PortableBackup(
    ...
    val version: Int = 1,
    val salt: String, // Base64 encoded salt used for KDF
    val encryptedPayload: String
)

data class BackupPayload(
    val myAlias: String,
    val entropy: String, // Root entropy for identity recovery
...
class BackupManager(private val context: Context) {
    ...
    fun restoreFromEncryptedBackup(backupJson: String, seed: List<String>): Boolean {
        return try {
