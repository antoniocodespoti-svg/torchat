...
object E2EManager {
     ...
     * RFC 8032 compliant deterministic derivation via JCA provider.
     */
    fun ed25519KeyPairFromSeed(seed: ByteArray): KeyPair {
        ...
        // We use a deterministic SecureRandom that perfectly feeds the seed into the generator.
        ...
        // Return the pair generated by the provider using our deterministic source.
        // This ensures the PrivateKey and PublicKey are mathematically linked correctly.
